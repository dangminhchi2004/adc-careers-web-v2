...
const DEMO_PAGE = PAGE_PATH.split("/").pop() || "index2.html";
...
${related.map(item => `
<a class="detail-related-card" href="index2.html?slug=${encodeURIComponent(item.slug)}" style="--related-color:${escapeAttribute(item.color || fallbackColor)}">
